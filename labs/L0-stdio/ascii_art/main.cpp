...
int main()
{
    ...
    string tom_line3 = center_text(tom_width, tom3);
    string info_line3 = center_text(middle_width - 2, "Author Name: " + programmer_name);
    string jerry_line3 = center_text(jerry_width, jerry3);
